...
<html lang="pt-BR">
<head>
	<title>Alterar instrução de votação</title>
	<meta charset="utf-8">
...
<body>
	<div class="container">
		<h2>Alterar instrucao votação</h2>
		<form name="form" method="post" action="exec_altera_ivotacao.php" onSubmit="return validacao();">
