					...
					<!-- 1 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Criar usuario criptografado</p>
                             <a href="votacao/user_cript.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Acesso a votação</p>
                                <a href="votacao/votar.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						<!-- 3 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Confere voto</strong>
                                </h4>
                                <p>Conferir votações</p>
                                <a href="votacao/confere_voto.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						<!--4 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Altera senha</strong>
                                </h4>
                                <p>Alterar senha</p>
                                <a href="alterar_senha.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						<!--5 new -->
                        <div class="col-md-3 col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:lemmis@gmail.com">lemmis@gmail.com</a>
                        </li>
                    </ul>
