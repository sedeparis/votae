	...
	<section id="services" class="services bg-primary-b">
		<div class="row ">
			<div class="col-lg-10 col-lg-offset-1">
				<div class="row">
					<div class="container">
						<h2>Auditoria Resultado</h2>
						<form  name="form" method="POST" action="verifica_auditoria.php" onSubmit="return validacao();">
							...
							<input type="button" name="cancela" value="Cancelar" onclick="window.location.href='../ce/admince.php'" class="btn btn-danger" />
							</div>
						</form>
					</div>
				<!-- /.row -->
