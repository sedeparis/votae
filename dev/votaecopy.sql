...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Dez-2019 às 21:32
...
--
-- Estrutura da tabela `autor_votar`
--

CREATE TABLE `autor_votar` (
  `idve` int(10) NOT NULL,
  `iduser` int(10) NOT NULL,
  `ideleicao` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `autor_votar`
--

INSERT INTO `autor_votar` (`idve`, `iduser`, `ideleicao`) VALUES
(1, 1, 0),
(2, 2, 0),
(3, 3, 0),
(4, 4, 0),
...
CREATE TABLE `candidatos` (
  `id` int(4) NOT NULL,
  `idchapa` int(4) NOT NULL,
  `candidato` varchar(100) NOT NULL,
  `ideleicao` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='candidatos';
...
INSERT INTO `cdorgao` (`idorgao`, `padrao`, `nome`, `cnpj`, `endereco`, `num`, `bairro`, `cidade`, `uf`, `email`, `fone`, `gestor`, `diretor`) VALUES
(1, 1, 'Teste', '12345678/0001-12', 'Rua aparecida', '10', 'Sata', 'Dourados', 'MS', 'teste@teste.com.br', '67-3110-5555', 'Teste', 'TEset');
...
CREATE TABLE `chapas` (
  ...
  `nchapa` varchar(3) NOT NULL,
  `representante` varchar(100) NOT NULL,
  `ideleicao` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `chapas` (`idchapa`, `situacao`, `chapa`, `nchapa`, `representante`, `ideleicao`) VALUES
(1, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(2, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(3, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(4, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(5, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(6, 'Ativo', '100 - Branco', '', 'Voto em Branco', 1),
(7, 'Ativo', '100 - Branco', '', 'Voto em Branco', 2),
(8, 'Ativo', '100 - Branco', '', 'Voto em Branco', 2),
(9, 'Ativo', '1- Azul', '', 'Azul', 1),
(10, 'Ativo', '2- Branco', '', 'Branco', 1),
(11, 'Ativo', '100 - Branco', '', 'Voto em Branco', 3),
(12, 'Ativo', '99 - Nulo', '', 'Voto nulo', 3),
(13, 'Ativo', 'Café preto', '1', 'café', 3),
(14, 'Ativo', 'capa', '0', 'chapa', 3);
...
INSERT INTO `condicao` (`id`, `sn`) VALUES
(1, 'Sim'),
(2, 'Não');
...
CREATE TABLE `eleicoes` (
  `ideleicao` int(4) NOT NULL,
  `eleicao` varchar(200) NOT NULL,
  `proposta` varchar(300) NOT NULL,
  `concluida` varchar(1) NOT NULL,
  `branco` varchar(3) NOT NULL,
  ...
  `tipo` int(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='eleicoes';

--
-- Extraindo dados da tabela `eleicoes`
--

INSERT INTO `eleicoes` (`ideleicao`, `eleicao`, `proposta`, `concluida`, `branco`, `nulo`, `aberta`, `data`, `hora`, `horaf`, `tipo`) VALUES
(1, 'Eleição 110 I - about', 'Cor da logo votae about', 'N', '1', '1', 1, '2019-12-06', '15:45', '16:45', 1),
(2, 'Eleição 110 II', 'Cor da logotipo', 'N', '1', '1', 0, '2019-12-06', '15:45', '16:45', 1),
(3, 'teste modificacao bn ALTERAADO', 'teste modificacao bn ALTERARADO', 'N', '', '', 0, '2019-12-09', '14:00', '15:00', 1);
...
--
-- Estrutura da tabela `ivotacao`
--

CREATE TABLE `ivotacao` (
  `idiv` int(6) NOT NULL,
  `ivotacao` varchar(300) NOT NULL,
  `complemento` varchar(300) NOT NULL,
  `ideleicao` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `ivotacao`
--

INSERT INTO `ivotacao` (`idiv`, `ivotacao`, `complemento`, `ideleicao`) VALUES
(1, 'AZUL 1; BRANCO 02', '', 1);
...
--
-- Extraindo dados da tabela `logs_eventos`
--

INSERT INTO `logs_eventos` (`idev`, `evento`, `valor`, `ideleicao`, `data`, `iduser`) VALUES
(1, 'Abertura', 'e10adc3949ba59abbe56e057f20f883e', 1, '20.09.2019 14:31:41', 0),
(2, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '05.12.2019 12:18:52', 0),
(3, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '05.12.2019 12:23:13', 0),
(4, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '05.12.2019 12:29:58', 0),
(5, 'Emissão da zerésima', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:29:51', 2),
(6, 'Emissão da zerésima', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:32:38', 2),
(7, 'Emissão da zerésima', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:32:54', 2),
(8, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:33:11', 0),
(9, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:37:00', 2),
(10, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:37:39', 2),
(11, 'Relatório para auditoria', '717b9b13e314fb8a412a555c8d1f0cad', 1, '06.12.2019 09:44:56', 2),
(12, 'Abertura', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 13:47:07', 0),
(13, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 13:58:09', 0),
(14, 'Abertura', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:00:41', 0),
(15, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:04:40', 0),
(16, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:06:16', 0),
(17, 'Abertura', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:08:10', 0),
(18, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:09:24', 0),
(19, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:11:42', 0),
(20, 'Emissão da zerésima', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:12:28', 2),
(21, 'Abertura', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:30:51', 0),
(22, 'Encerramento', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:31:10', 0),
(23, 'Abertura', '717b9b13e314fb8a412a555c8d1f0cad', 1, '09.12.2019 14:32:21', 0);
...
INSERT INTO `parametros` (`id`, `tipo`, `valor`) VALUES
(1, 'senhap', '717b9b13e314fb8a412a555c8d1f0cad'),
(2, 'versao', '1.1.1');
...
(1, 'sedenir.deparis@ifms.edu.br', '273f8f300e83f0f2483748e051138cff', 0),
(2, 'sedenir.deparis@ifms.edu.br', '1c340f7de04d750cc7302a6d66cd058a', 0),
(3, 'sedenir.deparis@ifms.edu.br', 'dbc7233d21355fa7d1e8b0b10caf7984', 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `recover_solicitation_adm`
--

CREATE TABLE `recover_solicitation_adm` (
  `id` int(20) UNSIGNED NOT NULL,
  `email` varchar(200) NOT NULL,
  `rash` varchar(200) NOT NULL,
  `status` int(20) NOT NULL DEFAULT '0'
...
--
-- Estrutura da tabela `tipo_eleicao`
--
...
--
-- Extraindo dados da tabela `tipo_eleicao`
--

INSERT INTO `tipo_eleicao` (`idtipo`, `tipo`) VALUES
(1, 'Eleição'),
(2, 'Consulta Pública');
...
--
-- Estrutura da tabela `tpuser`
--

CREATE TABLE `tpuser` (
  `id` int(2) NOT NULL,
  `tpuser` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tpuser`
--

INSERT INTO `tpuser` (`id`, `tpuser`) VALUES
...
CREATE TABLE `user` (
  ...
  `verificador` varchar(10) NOT NULL
...
INSERT INTO `user` (`id`, `codigo`, `nome`, `email`, `senha`, `situacao`, `verificador`) VALUES
(17, '1812621', 'Adriana de Melo Miranda Marques', '1812621', '202447d5d44ce12531f7207cb33b6bf7', 1, 'svt'),
(18, '2349353', 'Adriano Santos Do Nascimento', '2349353', '3038e58067', 1, 'ovt'),
(19, '1754310', 'Afonso Henrique Silva Leite', '1754310', '3038e58067', 1, 'evt'),
(20, '1761389', 'Agnaldo Nogueira Turina', '1761389', '3038e58067', 1, 'avt'),
(21, '1525643', 'Aislan Vieira de Melo', '1525643', '3038e58067', 1, 'ovt'),
(22, '2395499', 'Alan Borches Pinto', '2395499', '3038e58067', 1, 'ovt'),
(23, '2120725', 'Alessandro Riquelme Ribeiro', '2120725', '3038e58067', 1, 'ovt'),
(24, '2120725', 'Alessandro Riquelme Ribeiro', '2120725', '3038e58067', 1, 'ovt'),
(25, '1939710', 'Alex Ferreira da Silva', '1939710', '3038e58067', 1, 'avt'),
(26, '1870678', 'Alexandre dos Santos Lopes', '1870678', '3038e58067', 1, 'svt'),
(27, '2091918', 'Alexandre Francisco da Silva', '2091918', '3038e58067', 1, 'avt'),
(28, '1904787', 'Alfredo Goncalves Beda', '1904787', '3038e58067', 1, 'avt'),
(29, '2262726', 'Aline Gomes de Oliveira', '2262726', '3038e58067', 1, 'avt'),
(30, '1870874', 'Almir Jose Weinfortner', '1870874', '3038e58067', 1, 'rvt'),
(31, '2225942', 'Aloisio Henrique Pereira de Souza', '2225942', '3038e58067', 1, 'avt'),
(32, '2175597', 'Ana Claudia de Cordeue', '2175597', '3038e58067', 1, 'evt'),
(33, '1939938', 'Ana Lucia Cabral', '1939938', '3038e58067', 1, 'lvt'),
(34, '2297222', 'Anderson Bem', '2297222', '3038e58067', 1, 'mvt'),
(35, '1870588', 'Anderson Martins Correa', '1870588', '3038e58067', 1, 'avt'),
(36, '2152378', 'Anderson Susumu Kazama', '2152378', '3038e58067', 1, 'avt'),
(37, '1767216', 'Andre Carvalho Baida', '1767216', '3038e58067', 1, 'avt'),
(38, '1574146', 'Andre Luiz da Motta Silva', '1574146', '3038e58067', 1, 'avt'),
(39, '1866890', 'Andrea Marques Rosa Eduardo', '1866890', '3038e58067', 1, 'ovt'),
(40, '1449480', 'Aneilza de Carvalho Ferreira', '1449480', '3038e58067', 1, 'avt'),
(41, '2121977', 'Antonio Cesar Rodrigues Caires', '2121977', '3038e58067', 1, 'svt'),
(42, '1280625', 'Antonio de Freitas Neto', '1280625', '3038e58067', 1, 'ovt'),
(43, '1091389', 'Aparecido Amorim Ramos', '1091389', '3038e58067', 1, 'svt'),
(44, '1845110', 'Apio Carnielo E Silva', '1845110', '3038e58067', 1, 'avt'),
(45, '1844541', 'Ariana Trajano de Oliveira', '1844541', '3038e58067', 1, 'avt'),
(46, '1121785', 'Aroldo Careaga', '1121785', '3038e58067', 1, 'avt'),
(47, '1825717', 'Barbara Borges de Almeida', '1825717', '3038e58067', 1, 'avt'),
(48, '1889046', 'Bernaldo Luiz de Souza', '1889046', '3038e58067', 1, 'avt'),
(49, '1691374', 'Bruna Silveira Pavlack', '1691374', '3038e58067', 1, 'kvt'),
(50, '2310885', 'Calebe Pinheiro Ávila', '2310885', '3038e58067', 1, 'avt'),
(51, '2108379', 'Camila Arndt de Souza', '2108379', '3038e58067', 1, 'avt'),
(52, '2351498', 'Carla Gilmeres Aparecida Lima', '2351498', '3038e58067', 1, 'avt'),
(53, '1838009', 'Carla Renata Capilé Silva', '1838009', '3038e58067', 1, 'avt'),
(54, '1873250', 'Carlos Aparecido de Almeida', '1873250', '3038e58067', 1, 'avt'),
(55, '1887579', 'Carmem Betty Batista da Silva', '1887579', '3038e58067', 1, 'avt'),
(56, '2106196', 'Caroline Hardoim Simões', '2106196', '3038e58067', 1, 'svt'),
(57, '2106196', 'Caroline Hardoim Simões', '2106196', '3038e58067', 1, 'svt'),
(58, '2353738', 'Cezar da Silva Bezerra', '2353738', '3038e58067', 1, 'avt'),
(59, '2407311', 'Cibele Runichi Fonseca', '2407311', '3038e58067', 1, 'avt'),
(60, '1548877', 'Cinara Baccili Ribeiro', '1548877', '3038e58067', 1, 'ovt'),
(61, '1870283', 'Claudia Leite Munhoz', '1870283', '3038e58067', 1, 'zvt'),
(62, '1051904', 'Claudia Rosane Ribeiro Alves', '1051904', '3038e58067', 1, 'svt'),
(63, '2353880', 'Claudinei Garcia', '2353880', '3038e58067', 1, 'avt'),
(64, '2356525', 'Clauzer Antônio Silveira de Toledo', '2356525', '3038e58067', 1, 'ovt'),
(65, '1543303', 'Cleiton Zoia Munchow', '1543303', '3038e58067', 1, 'wvt'),
(66, '1948265', 'Daiane Araujo Lemos de Almeida', '1948265', '3038e58067', 1, 'avt'),
(67, '2221441', 'Daniela Bulcao Santi', '2221441', '3038e58067', 1, 'ivt'),
(68, '1573302', 'Danieli Daiani Francisquini', '1573302', '3038e58067', 1, 'ivt'),
(69, '2396696', 'Danilo Cesar Pereira', '2396696', '3038e58067', 1, 'avt'),
(70, '1569340', 'Danilo Ribeiro de Sá Teles', '1569340', '3038e58067', 1, 'svt'),
(71, '2376670', 'Davi Augusto Fernandes de Souza', '2376670', '3038e58067', 1, 'avt'),
(72, '1848225', 'Debora Rogeria de Souza Garcia', '1848225', '3038e58067', 1, 'avt'),
(73, '2001971', 'Dejahyr Lopes Junior', '2001971', '3038e58067', 1, 'rvt'),
(74, '2173129', 'Diego Farias Falcao de Carvalho', '2173129', '3038e58067', 1, 'ovt'),
(75, '1334985', 'Diego Saqui', '1334985', '3038e58067', 1, 'ivt'),
(76, '1818010', 'Dilson Almeida dos Santos', '1818010', '3038e58067', 1, 'svt'),
(77, '2967419', 'Diogo Chadud Milagres', '2967419', '3038e58067', 1, 'svt'),
(78, '1946364', 'Dorgival Pereira da Silva Netto', '1946364', '3038e58067', 1, 'ovt'),
(79, '1846204', 'Eder Samaniego Villalba', '1846204', '3038e58067', 1, 'avt'),
(80, '1648730', 'Edgard José dos Santos Arinos', '1648730', '3038e58067', 1, 'svt'),
(81, '1706525', 'Edi Carlos Aparecido Marques', '1706525', '3038e58067', 1, 'svt'),
(82, '2234887', 'Edinalva Lopes Brasil', '2234887', '3038e58067', 1, 'lvt'),
(83, '1870414', 'Edson dos Santos Bortoloto', '1870414', '3038e58067', 1, 'ovt'),
(84, '1127695', 'Eduardo Fernandes Vieira dos Santos', '1127695', '3038e58067', 1, 'svt'),
(85, '2353359', 'Eduardo Reis Pieretti', '2353359', '3038e58067', 1, 'ivt'),
(86, '2336536', 'Eduardo Rodrigues Vieira', '2336536', '3038e58067', 1, 'avt'),
(87, '1941845', 'Elaine Borges Monteiro Cassiano', '1941845', '3038e58067', 1, 'ovt'),
(88, '1131609', 'Elisa de Almeida Souza', '1131609', '3038e58067', 1, 'avt'),
(89, '1124514', 'Eliton da Silva', '1124514', '3038e58067', 1, 'avt'),
(90, '2378780', 'Elizandra Prates de Oliveira Miranda', '2378780', '3038e58067', 1, 'avt'),
(91, '1043643', 'Elke Leite Bezerra', '1043643', '3038e58067', 1, 'avt'),
(92, '2977105', 'Erika Fernandes Neves', '2977105', '3038e58067', 1, 'svt'),
(93, '1226433', 'Erika Yurie Fujiwara', '1226433', '3038e58067', 1, 'avt'),
(94, '2264072', 'Eva Emannuelly Miranda Silva', '2264072', '3038e58067', 1, 'avt'),
(95, '2303932', 'Evaldo Souza Rocha', '2303932', '3038e58067', 1, 'avt'),
(96, '2349509', 'Everton Melo de Oliveira', '2349509', '3038e58067', 1, 'avt'),
(97, '1370265', 'Fabiana Aparecida Rodrigues', '1370265', '3038e58067', 1, 'svt'),
(98, '2395564', 'Fábio Dias Rocha', '2395564', '3038e58067', 1, 'avt'),
(99, '2343888', 'Fabio Luiz Faria da Silva', '2343888', '3038e58067', 1, 'avt'),
(100, '2309398', 'Felipe Coelho Senna', '2309398', '3038e58067', 1, 'avt'),
(101, '3056366', 'Felipe Lovatto', '3056366', '3038e58067', 1, 'ovt'),
(102, '1760552', 'Fernanda Ferreira Chaves', '1760552', '3038e58067', 1, 'svt'),
(103, '2175473', 'Flavia Ferreira Barbosa', '2175473', '3038e58067', 1, 'avt'),
(104, '1107476', 'Flavia Regina Grego', '1107476', '3038e58067', 1, 'ovt'),
(105, '3007380', 'Flavia Renata Abreu de Souza', '3007380', '3038e58067', 1, 'avt'),
(106, '1041718', 'Francielle Priscyla Pott', '1041718', '3038e58067', 1, 'tvt'),
(107, '2961293', 'Francisco Leonor de Amarilio', '2961293', '3038e58067', 1, 'ovt'),
(108, '1752411', 'Franz Eubanque Corsini', '1752411', '3038e58067', 1, 'ivt'),
(109, '1410550', 'Gabriel Paganini Faggioni', '1410550', '3038e58067', 1, 'ivt'),
(110, '1896721', 'Geverson Luis Dierings', '1896721', '3038e58067', 1, 'svt'),
(111, '1086126', 'Glauber Correa da Costa Flores Ribeiro de Carvalho', '1086126', '3038e58067', 1, 'ovt'),
(112, '2268416', 'Gracieth Mendes Valenzuela', '2268416', '3038e58067', 1, 'avt'),
(113, '2278827', 'Greiciane Antunes', '2278827', '3038e58067', 1, 'svt'),
(114, '1876591', 'Guilherme Costa Garcia', '1876591', '3038e58067', 1, 'avt'),
(115, '2350676', 'Guilherme Figueiredo Terenciani', '2350676', '3038e58067', 1, 'ivt'),
(116, '2847473', 'Guilherme Semionato Galicio', '2847473', '3038e58067', 1, 'ovt'),
(117, '1314596', 'Gustavo Fantini Fernandes', '1314596', '3038e58067', 1, 'svt'),
(118, '2390598', 'Gustavo Medina Araujo', '2390598', '3038e58067', 1, 'ovt'),
(119, '1812747', 'Gutemberk Navarro Inzabral', '1812747', '3038e58067', 1, 'lvt'),
(120, '2128683', 'Helder Sousa Pimenta', '2128683', '3038e58067', 1, 'avt'),
(121, '2336698', 'Hudson Alves Martins', '2336698', '3038e58067', 1, 'svt'),
(122, '2305617', 'Hugo Eduardo Pimentel Motta Siscar', '2305617', '3038e58067', 1, 'rvt'),
(123, '1018824', 'Ianamary Monteiro Marcondes', '1018824', '3038e58067', 1, 'svt'),
(124, '1888093', 'Isnael de Camargo Dias', '1888093', '3038e58067', 1, 'svt'),
(125, '2359654', 'Ivilaine Pereira Delguingaro', '2359654', '3038e58067', 1, 'ovt'),
(126, '1912652', 'Jair Brito da Costa', '1912652', '3038e58067', 1, 'avt'),
(127, '1846485', 'Janaína Mara Pacco Mendes', '1846485', '3038e58067', 1, 'svt'),
(128, '1863217', 'Janete Andrade de Lima', '1863217', '3038e58067', 1, 'avt'),
(129, '2961362', 'Jeannette Gloria Cordova Pereyra', '2961362', '3038e58067', 1, 'avt'),
(130, '1451357', 'Jeferson de Arruda', '1451357', '3038e58067', 1, 'avt'),
(131, '2349823', 'Jessica dos Santos Paiao', '2349823', '3038e58067', 1, 'ovt'),
(132, '1856763', 'Jiyan Yari', '1856763', '3038e58067', 1, 'ivt'),
(133, '1844931', 'Jocimara Paiva Grillo', '1844931', '3038e58067', 1, 'ovt'),
(134, '2296599', 'Joel Barbosa Ferreira', '2296599', '3038e58067', 1, 'avt'),
(135, '2326465', 'Joelson Ortiz Ramos', '2326465', '3038e58067', 1, 'svt'),
(136, '2139248', 'Jose Aparecido Silva de Jesus', '2139248', '3038e58067', 1, 'svt'),
(137, '2058753', 'José Wilton Fonseca da Silva', '2058753', '3038e58067', 1, 'avt'),
(138, '2938386', 'Joseila Aparecida Bergamo', '2938386', '3038e58067', 1, 'ovt'),
(139, '2120148', 'Juliana Danielly de R. Miguel', '2120148', '3038e58067', 1, 'lvt'),
(140, '1352237', 'Julio Marques Cardoso', '1352237', '3038e58067', 1, 'ovt'),
(141, '2309489', 'Jussara Hilario dos Santos', '2309489', '3038e58067', 1, 'svt'),
(142, '1272989', 'Kader Carvalho Assad', '1272989', '3038e58067', 1, 'dvt'),
(143, '1944527', 'Kariston Eger dos Santos', '1944527', '3038e58067', 1, 'svt'),
(144, '1954583', 'Lais Fernanda Deleon', '1954583', '3038e58067', 1, 'nvt'),
(145, '1190043', 'Laryssa Amaro Naumann Pereira Dias', '1190043', '3038e58067', 1, 'svt'),
(146, '2357048', 'Layla Oliveira de Moraes', '2357048', '3038e58067', 1, 'svt'),
(147, '2120078', 'Leila da Silva Santos', '2120078', '3038e58067', 1, 'svt'),
(148, '1870625', 'Leonardo Borges Reis', '1870625', '3038e58067', 1, 'svt'),
(149, '1287572', 'Leonardo Bronel Duarte', '1287572', '3038e58067', 1, 'evt'),
(150, '2152249', 'Leticia de Arruda Dias Finotti', '2152249', '3038e58067', 1, 'ivt'),
(151, '1345845', 'Lucas Gustavo Yock Durante', '1345845', '3038e58067', 1, 'evt'),
(152, '2340388', 'Luciana Emanuelle Sanches Silva', '2340388', '3038e58067', 1, 'avt'),
(153, '2091543', 'Luciene da Silva Santos Bonfim', '2091543', '3038e58067', 1, 'mvt'),
(154, '1333901', 'Luis Eduardo Moraes Sinesio', '1333901', '3038e58067', 1, 'ovt'),
(155, '2152646', 'Luis Henrique Camarco Costa', '2152646', '3038e58067', 1, 'avt'),
(156, '2290584', 'Luis Otavio Mendes', '2290584', '3038e58067', 1, 'svt'),
(157, '1761398', 'Luiz Fernando Delboni Lomba', '1761398', '3038e58067', 1, 'avt'),
(158, '1725244', 'Luzitania Dall Agnol', '1725244', '3038e58067', 1, 'lvt'),
(159, '1976576', 'Manoel Felipe da Paz Almeida', '1976576', '3038e58067', 1, 'avt'),
(160, '2121761', 'Mara Márcia de O. Vono Santana', '2121761', '3038e58067', 1, 'avt'),
(161, '2357666', 'Marcela Aparecida Dorneles Duarte', '2357666', '3038e58067', 1, 'evt'),
(162, '1503164', 'Marcelo Kuchar Matte', '1503164', '3038e58067', 1, 'evt'),
(163, '1225320', 'Marcelo Salvador Garcia', '1225320', '3038e58067', 1, 'avt'),
(164, '1265845', 'Marcia Helena de A. R. de Oliveira', '1265845', '3038e58067', 1, 'avt'),
(165, '2091553', 'Marco Aurelio Andrade Massilon', '2091553', '3038e58067', 1, 'nvt'),
(166, '1887912', 'Marcos S. Figuereido Zacarias', '1887912', '3038e58067', 1, 'svt'),
(167, '1374410', 'Maria Denise Bortolini', '1374410', '3038e58067', 1, 'ivt'),
(168, '1995814', 'Maria Jose Vasconcelos Pereira', '1995814', '3038e58067', 1, 'avt'),
(169, '2124522', 'Maria Laudicéia Gonçalves Soares', '2124522', '3038e58067', 1, 'svt'),
(170, '2370781', 'Maria Lúcia de Oliveira', '2370781', '3038e58067', 1, 'avt'),
(171, '1672980', 'Maria Silvana Rodrigues', '1672980', '3038e58067', 1, 'svt'),
(172, '2924701', 'Mariana Aparecida Soares', '2924701', '3038e58067', 1, 'svt'),
(173, '3008883', 'Mariana Arndt de Souza', '3008883', '3038e58067', 1, 'avt'),
(174, '1950368', 'Mariana de Oliveira', '1950368', '3038e58067', 1, 'avt'),
(175, '1911468', 'Marilene da Silva Ribeiro', '1911468', '3038e58067', 1, 'ovt'),
(176, '1832271', 'Mariluci Moraes Do Amaral', '1832271', '3038e58067', 1, 'lvt'),
(177, '2231325', 'Marlon Acosta Flores', '2231325', '3038e58067', 1, 'svt'),
(178, '1900178', 'Matheus Jardim Guerreiro da Silva', '1900178', '3038e58067', 1, 'avt'),
(179, '1823063', 'Mauro Conte Pereira', '1823063', '3038e58067', 1, 'avt'),
(180, '1873060', 'Mauro Vanderlei de Amorim', '1873060', '3038e58067', 1, 'mvt'),
(181, '2413766', 'Natalia Borges Marcelino', '2413766', '3038e58067', 1, 'ovt'),
(182, '2152602', 'Odair Diemer', '2152602', '3038e58067', 1, 'rvt'),
(183, '2092806', 'Orico dos Santos Balta', '2092806', '3038e58067', 1, 'avt'),
(184, '2171765', 'Otoniel Francis Mendoza Ferreira', '2171765', '3038e58067', 1, 'avt'),
(185, '2103316', 'Paula Lobo Soares', '2103316', '3038e58067', 1, 'svt'),
(186, '2309504', 'Paula Renata Cameschi de Souza', '2309504', '3038e58067', 1, 'avt'),
(187, '2360251', 'Paula Renata de Morais Gomes Freitas', '2360251', '3038e58067', 1, 'svt'),
(188, '1439136', 'Paulo Henrique A. Braga', '1439136', '3038e58067', 1, 'avt'),
(189, '2413728', 'Paulo Henrique da Silva Augusto', '2413728', '3038e58067', 1, 'ovt'),
(190, '1946224', 'Paulo Luiz Miranda Tavares', '1946224', '3038e58067', 1, 'svt'),
(191, '1312941', 'Pedro Henrique Neves da Silva', '1312941', '3038e58067', 1, 'avt'),
(192, '1150537', 'Pedro Jorge Cardoso da Silva Rodrigues', '1150537', '3038e58067', 1, 'svt'),
(193, '2395486', 'Poliana Neves Peres', '2395486', '3038e58067', 1, 'svt'),
(194, '3007066', 'Rafaela Chivalski de Oliveira', '3007066', '3038e58067', 1, 'avt'),
(195, '1848471', 'Raquel Pyramides Barbosa Pimenta', '1848471', '3038e58067', 1, 'avt'),
(196, '1824257', 'Raquel Santos', '1824257', '3038e58067', 1, 'svt'),
(197, '1359637', 'Reginaldo Chaparro', '1359637', '3038e58067', 1, 'ovt'),
(198, '1879410', 'Reinaldo Mesquita Cassiano', '1879410', '3038e58067', 1, 'ovt'),
(199, '1208413', 'Renilce Miranda Cebalho Barbosa', '1208413', '3038e58067', 1, 'avt'),
(200, '2142466', 'Ricardo Antônio Pereira Velho', '2142466', '3038e58067', 1, 'ovt'),
(201, '3062337', 'Ricardo Antonio Sampaio da Costa', '3062337', '3038e58067', 1, 'avt'),
(202, '2308482', 'Ricardo de Carvalho', '2308482', '3038e58067', 1, 'ovt'),
(203, '1895873', 'Ricardo Pereira Zanella', '1895873', '3038e58067', 1, 'avt'),
(204, '2091822', 'Ricardo Regis Ferreira de Arruda', '2091822', '3038e58067', 1, 'avt'),
(205, '1760970', 'Roberta de Almeida Sorano Tropaldi', '1760970', '3038e58067', 1, 'ivt'),
(206, '2100373', 'Roberta Ferreira de Souza', '2100373', '3038e58067', 1, 'avt'),
(207, '2083243', 'Roberto Medeiros Silveira', '2083243', '3038e58067', 1, 'avt'),
(208, '1900365', 'Roberto Pagliosa Branco', '1900365', '3038e58067', 1, 'ovt'),
(209, '2355628', 'Robson de Araujo Filho', '2355628', '3038e58067', 1, 'ovt'),
(210, '1855862', 'Robson Lubas Arguelho', '1855862', '3038e58067', 1, 'ovt'),
(211, '1312120', 'Rodrigo Assad Pereira', '1312120', '3038e58067', 1, 'avt'),
(212, '2349232', 'Rodrigo dos Santos Angelino', '2349232', '3038e58067', 1, 'ovt'),
(213, '1876544', 'Rogerio Cardoso Batista', '1876544', '3038e58067', 1, 'avt'),
(214, '2409603', 'Rogers Espinosa de Oliveira', '2409603', '3038e58067', 1, 'avt'),
(215, '2308498', 'Ronaldo Aquino', '2308498', '3038e58067', 1, 'ovt'),
(216, '1036110', 'Roney Rojer Ortiz Garcia', '1036110', '3038e58067', 1, 'avt'),
(217, '2923948', 'Rosalice Souza Santiago', '2923948', '3038e58067', 1, 'ovt'),
(218, '2349410', 'Rosana Cristina de Azevedo', '2349410', '3038e58067', 1, 'ovt'),
(219, '1919031', 'Rubens Cesar Ferreira Pereira', '1919031', '3038e58067', 1, 'avt'),
(220, '2205089', 'Samara Melo Valcacer', '2205089', '3038e58067', 1, 'rvt'),
(221, '1633322', 'Sandro Moura Santos', '1633322', '3038e58067', 1, 'svt'),
(222, '2100086', 'Sedenir Marcos Deparis', 'sedenir.deparis@ifms.edu.br', 'be2d8fce4c8126e60d35bd58018c457b', 1, 'svt'),
(223, '2393449', 'Sergio de Souza Pires', '2393449', '3038e58067', 1, 'svt'),
(224, '2407284', 'Shirley Maria da Costa de Araujo', '2407284', '3038e58067', 1, 'ovt'),
(225, '3010651', 'Sidney Cherman Zolabarrieta Costa', '3010651', '3038e58067', 1, 'avt'),
(226, '2000743', 'Sidney Roberto de Sousa', '2000743', '3038e58067', 1, 'avt'),
(227, '1709277', 'Silvana Colombelli Parra Sanches', '1709277', '3038e58067', 1, 'svt'),
(228, '2349808', 'Silvania Rizzi Brasil', '2349808', '3038e58067', 1, 'lvt'),
(229, '1823292', 'Silvia Aratani Marinho Nascimento', '1823292', '3038e58067', 1, 'ovt'),
(230, '1946801', 'Silvia Barbosa Barros', '1946801', '3038e58067', 1, 'svt'),
(231, '2357077', 'Silvia Cristina de Freitas Cidrão', '2357077', '3038e58067', 1, 'ovt'),
(232, '1680871', 'Silvia Gonçalves Santos', '1680871', '3038e58067', 1, 'svt'),
(233, '2357197', 'Silvio Mendes Mazarin', '2357197', '3038e58067', 1, 'nvt'),
(234, '1866885', 'Simone Estigarribia de Lima', '1866885', '3038e58067', 1, 'avt'),
(235, '1454796', 'Sintya de Santis Ascencio', '1454796', '3038e58067', 1, 'ovt'),
(236, '2321137', 'Stone Marisco Duarte', '2321137', '3038e58067', 1, 'evt'),
(237, '3061253', 'Suelen Fernanda Ranucci Pini', '3061253', '3038e58067', 1, 'ivt'),
(238, '2378861', 'Suély Copini', '2378861', '3038e58067', 1, 'ivt'),
(239, '1846107', 'Suzana de Morais Berriel', '1846107', '3038e58067', 1, 'lvt'),
(240, '176500', 'Suziane Freitas de Sousa', '176500', '3038e58067', 1, 'avt'),
(241, '2968013', 'Tadeu Candido Coelho Loibel', '2968013', '3038e58067', 1, 'lvt'),
(242, '1868951', 'Tatiane Alfonso de Araujo', '1868951', '3038e58067', 1, 'ovt'),
(243, '2376797', 'Thais Adriana Colman Novaes', '2376797', '3038e58067', 1, 'svt'),
(244, '1704636', 'Thamyris Fernandes da Silva', '1704636', '3038e58067', 1, 'avt'),
(245, '1267030', 'Thiago de Oliveira Correia', '1267030', '3038e58067', 1, 'avt'),
(246, '2373325', 'Tiago Machado Faria de Souza', '2373325', '3038e58067', 1, 'avt'),
(247, '2121712', 'Tiago Thomaz de Assis', '2121712', '3038e58067', 1, 'svt'),
(248, '2303897', 'Tiago Tristão Artero', '2303897', '3038e58067', 1, 'ovt'),
(249, '2357808', 'Tomaz Leal Leite', '2357808', '3038e58067', 1, 'evt'),
(250, '1646303', 'Valquiria Barbosa Nantes Ferreira', '1646303', '3038e58067', 1, 'avt'),
(251, '1771139', 'Vanessa da Silva Alves Gossler', '1771139', '3038e58067', 1, 'rvt'),
(252, '1584041', 'Veronica Elizabeth Rivas', '1584041', '3038e58067', 1, 'svt'),
(253, '1506146', 'Victor Tartas', '1506146', '3038e58067', 1, 'svt'),
(254, '1879591', 'Vitor Quadros Altomare Sanches', '1879591', '3038e58067', 1, 'svt'),
(255, '1311456', 'Viviane Santos', '1311456', '3038e58067', 1, 'svt'),
(256, '2728985', 'Walterisio Goncalves Carneiro Junior', '2728985', '3038e58067', 1, 'rvt'),
(257, '2231335', 'Wilian Martins de Carvalho', '2231335', '3038e58067', 1, 'ovt');
...
INSERT INTO `users` (`id`, `nome`, `tpuser`, `admin`, `email`, `senha`, `situacao`, `ideleicao`, `verificador`) VALUES
(1, 'Administrador', 4, 'Sim', 'adm', '717b9b13e314fb8a412a555c8d1f0cad', '1', 0, ''),
(2, 'Admcomissao', 1, 'Não', 'com', '717b9b13e314fb8a412a555c8d1f0cad', '1', 0, '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `user_votou`
--

CREATE TABLE `user_votou` (
  `id` int(6) NOT NULL,
  `iduser` varchar(35) NOT NULL,
  `ide` int(4) NOT NULL,
  `votou` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `user_votou`
--

INSERT INTO `user_votou` (`id`, `iduser`, `ide`, `votou`) VALUES
(1, '1812621', 1, 0),
(2, '2349353', 1, 0),
(3, '1754310', 1, 0),
(4, 'usuario4', 1, 0),
...
INSERT INTO `votacao` (`id`, `ide`, `idv`, `voto`) VALUES
(10, 1, '09c0e62b91223777e753bf5a3fbb44', 2);
...
CREATE TABLE `votantes` (
  ...
  `votou` int(2) NOT NULL,
  `ide` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='votantes';

--
-- Extraindo dados da tabela `votantes`
--

INSERT INTO `votantes` (`idv`, `iduser`, `votou`, `ide`) VALUES
(13, '222', 0, 1),
(14, '222', 1, 1),
(15, '222', 1, 1);
...
--
-- Indexes for table `autor_votar`
--
ALTER TABLE `autor_votar`
...
--
-- Indexes for table `ivotacao`
--
ALTER TABLE `ivotacao`
  ADD PRIMARY KEY (`idiv`);

--
-- Indexes for table `logs_eventos`
--
...
--
-- Indexes for table `recover_solicitation_adm`
--
ALTER TABLE `recover_solicitation_adm`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tipo_eleicao`
--
ALTER TABLE `tipo_eleicao`
  ADD PRIMARY KEY (`idtipo`);

--
-- Indexes for table `tpuser`
--
ALTER TABLE `tpuser`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_votou`
--
ALTER TABLE `user_votou`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `autor_votar`
--
ALTER TABLE `autor_votar`
  MODIFY `idve` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `cdsituacao`
  MODIFY `idsit` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `chapas`
--
ALTER TABLE `chapas`
  MODIFY `idchapa` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `eleicoes`
  MODIFY `ideleicao` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ivotacao`
--
ALTER TABLE `ivotacao`
  MODIFY `idiv` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `logs_eventos`
--
ALTER TABLE `logs_eventos`
  MODIFY `idev` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
-- AUTO_INCREMENT for table `recover_solicitation_adm`
--
ALTER TABLE `recover_solicitation_adm`
  MODIFY `id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tipo_eleicao`
--
ALTER TABLE `tipo_eleicao`
  MODIFY `idtipo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tpuser`
--
ALTER TABLE `tpuser`
...
--
ALTER TABLE `user`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
...
--
-- AUTO_INCREMENT for table `user_votou`
--
ALTER TABLE `user_votou`
...
--
ALTER TABLE `votantes`
  MODIFY `idv` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
