					...
					<!-- 1 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Incluir Usuário ACF</strong>
                                </h4>
							
                             <a href="cd_usuario_acf.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Aprovar Adm</strong>
                                </h4>
                               
								
                                <a href="aprova_usuario.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <a href="cd_orgao_padrao.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						<!--4 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Alterar órgão</strong>
                                </h4>
                                
                                <a href="altera_orgao_padrao.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						      </div>
                    <!-- /.row (nested) -->
					...
					<!-- 1 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Alterar Senha ACF</strong>
                                </h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>Alterar senha inicial</strong>
                                </h4>
                              
								
                                <a href="altera_senha_padrao.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
						<!-- 3 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <a href="logoutadm.php" class="btn btn-light">Sair</a>
                            </div>
                        </div>
						<!--4 new -->
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <a href="admin.php" class="btn btn-light">Acessar</a>
                            </div>
                        </div>
