...
<input class="form-control" type="password" name="senha"/> 
 ...
 <div class="form-group">
<input type="submit" value="Administrar" class="btn btn-primary"/>
<input type="reset" value="Limpar" class="btn btn-warning"/>
<input type="button" name="cancela" value="Cancelar" onclick="window.location.href='../index.php'" class="btn btn-danger"/>
<input type="button" name="esqsenha" value="Esqueci minha senha" onclick="window.location.href='esqueci_senha.php'" class="btn btn-info"/>
</form>
</div>
<div class="container">
<?php	   
